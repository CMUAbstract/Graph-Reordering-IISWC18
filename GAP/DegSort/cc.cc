...
void PrintCompStats(const Graph &g, const pvector<NodeID> &comp, pvector<NodeID> &newIds) {
  cout << endl;
...
int main(int argc, char* argv[]) {
  ...
  Graph sorted_g = Builder::degreeSort(g, (cli.relabel() == 0), newIds, false, false); 
  BenchmarkKernel(cli, sorted_g, ShiloachVishkin, PrintCompStats, CCVerifier, newIds);
  return 0;
}
